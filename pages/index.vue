  ...
  <div>
    ...
    <div v-else class="h-screen relative">
      ...
      <div class="relative h-full">
        ...
        <div class="absolute inset-0 bg-pink opacity-30"></div>
        ...
        <div class="info flex flex-col items-center justify-center h-screen relative">
          <div class="container text-left p-1 lg:p-20">
            <div
              class="container opacity-80 animate-fade animate-once animate-delay-[100ms] text-blue"
            >
              <!-- Title -->
              <div class="relative">
                <div class="blur-text md:text-9xl font-w ">{{ displayedTitle }}</div>
                <div class="text-4xl md:text-9xl font-black  border-red pr-2 ">
                  {{ displayedTitle }}
                </div>
              </div>
              ...
              <div class="relative mt-4">
                <div class="blur-text text-2xl font-semibold bebas-neue-regular">{{ displayedSubtitle }}</div>
                <div class="text-2xl blurcolor-white font-semibold">{{ displayedSubtitle }}</div>
              </div>
...
.blur-text {
  ...
  left: 0;
  font-size: 4xl;
  color: rgb(242, 215, 167); /* Black text for contrast */
  opacity: 0.9; /* Adjust for a subtle blur */
